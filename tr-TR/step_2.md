## Bir yapay zekâ görsel oluşturucuya komut ver
...
Temel bir fikirle başlayın. İşte başlangıç noktanız, görüntünün nesnesi.

Örnek: "Bir kedi."

Bu komutu görüntü oluşturucuda çalıştırın. Bakalım ne üretecek.
...
Ayrıntıları düşünün. Ne tür bir kedi? Ne yapıyor?

Örnek: "**Pencere kenarında oturan** **tüylü beyaz** bir kedi."

Bu yeni komutu çalıştırın ve ilk görüntüyle karşılaştırın. Nasıl değişti?
...
Olay nerede geçiyor? Bir ayar eklemek, model için komutunuzu daha açıklayıcı hâle getirir ve resimdeki nesneyle ilgili ayrıntıları sunar.

Örnek: "**Rahat bir oturma odasında** pencere pervazında oturan kabarık beyaz bir kedi."

Güncellenmiş komutu çalıştırın. Ortaya çıkan yeni unsurlara dikkat edin.
...
Sahnede başka neler olmalı?

Örnek: "Rahat bir oturma odasında, pencere pervazında oturan kabarık beyaz bir kedi **yanında saksıda bir bitki**."

Güncellenmiş komutu çalıştırın. Ek detaylar görüntüyü nasıl değiştiriyor?
...
Renkler ve stiller görüntünüze karakter katar. Ne tür bir ruh hâli veya tarz istiyorsunuz?

Örnek: "Rahat, **eski tarz** bir oturma odasında, pencere pervazında oturan kabarık beyaz bir kedi ve yanında **yeşil** bir saksı bitkisi."

Komutu çalıştırın. Renklerin ve stilin görüntüyü nasıl etkilediğine bakın.
...
Görüntü nasıl oluşturulmalı? Yakın çekim mi yoksa geniş açı mı?

Örnek: "**Yakın çekim:** Rahat, eski tarz bir oturma odasında, pencere pervazında oturan kabarık beyaz bir kedi ve yanında yeşil bir saksı bitkisi."

Komutu çalıştırın ve kompozisyonun değiştirilmesinin görüntünün odak noktasını nasıl değiştirdiğini görün.
...
Görsele metin eklemek istiyorsanız, metnin ne olması gerektiğini ve nasıl görünmesi gerektiğini belirtin.

Örnek: "Rahat, eski tarz bir oturma odasında, pencere pervazında oturan kabarık beyaz bir kedinin yakın çekim görüntüsü, yanında yeşil bir saksı bitkisi ve **altta el yazısı fontuyla 'Evim Güzel Evim' yazısı**."

Komutu çalıştırın. Metnin istediğiniz gibi görünüp görünmediğini ve görüntüyle uyumlu olup olmadığını kontrol edin.
...
Komutunuzu görüntü oluşturucu ile test edin. Mükemmel değilse, ayrıntıları ayarlayın ve tekrar deneyin. Önceki görsellerde kedinin gözlerinin renginin değiştiğini fark etmiş olabilirsiniz. Bunu şimdi düzeltebilirsiniz.

Örnek: "Rahat, eski tarz bir oturma odasında, pencere pervazında oturan, yanında yeşil saksıda bir bitki bulunan, **mavi gözlü**, kabarık beyaz bir kedinin yakın çekim fotoğrafı; altta el yazısı fontuyla 'Evim Güzel Evim' yazısı."

Güncellenmiş komutu çalıştırın. Görsel, fikrinize uyana kadar gerekli değişiklikleri yapın.
