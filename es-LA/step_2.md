...
Comience con una idea básica. Ése es tu punto de partida: el objeto de la imagen.

Ejemplo: "Un gato".

Ejecute esta instrucción en el generador de imágenes. Vea lo que produce.
...
Ejemplo: "Un gato **blanco y suave** **sentado en una ventana**."
...
¿Dónde está ocurriendo la escena? Agregar un escenario hace que su mensaje sea más descriptivo para el modelo, brindando detalles sobre el objeto de la imagen.

Ejemplo: "Un gato blanco y esponjoso sentado en el alféizar de una ventana **en una acogedora sala de estar**".

Ejecute la petición actualizada. Observa los nuevos elementos que aparecen.
...
¿Qué otras cosas deberían aparecer en la escena?

Ejemplo: "Un gato blanco y peludo sentado en el marco de una ventana **con una planta en una maceta al lado**, en una sala acogedora."

Ejecute la petición actualizada. ¿Cómo cambian los detalles adicionales la imagen?
...
Los colores y estilos añaden carácter a tu imagen. ¿Qué ambiente o estilo deseas?

Ejemplo: "Un gato blanco y peludo sentado en el marco de una ventana con una planta **verde** en una maceta al lado, en una sala acogedora y de **estilo vintage**."

Ejecuta las indicaciones. Mira cómo los colores y el estilo afectan la imagen.
...
¿Cómo debería estar compuesta la imagen? ¿Es un primer plano o un plano general?

Ejemplo: "**Un primer plano** de un gato blanco y peludo sentado en el marco de una ventana con una planta verde en un maceta al lado, en una sala acogedora y de estilo vintage."

Ejecuta las instrucciones y mira cómo el cambio en la composición cambia el foco de la imagen.
...
Si deseas texto en la imagen, incluye lo que debería decir y cómo debería verse.

Ejemplo: "Un primer plano de un gato blanco y peludo sentado en el marco de una ventana con una planta verde en un macetero al lado, en una sala acogedora y de estilo vintage **con el texto 'Hogar Dulce Hogar' en letra cursiva en la parte inferior**."

Ejecuta las instrucciones. Revisa si el texto aparece como lo deseas y que se acomoda bien con la imagen.
...
Pon tus instrucciones a prueba con el generador de imágenes. Si no es perfecta, ajusta los detalles e intentalo nuevamente. A través de las imágenes anteriores, habrás notado que los ojos del gato cambiaron de color. Puedes arreglar eso ahora.

Ejemplo: "Un primer plano de un gato blanco y peludo **con ojos azules** sentado en el marco de una ventana con una planta verde en una maceta al lado, en una sala acogedora de estilo vintage, con el texto 'Hogar Dulce Hogar' en letra cursiva en la parte inferior."

Ejecute la petición actualizada. Haz los cambios que creas necesarios hasta que la imagen se adecúe a tu idea.
